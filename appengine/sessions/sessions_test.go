...
func TestDatastoreSessionnFlashes(t *testing.T) {
	store := NewDatastoreStore("", []byte("secret-key"))
	testSessionFlashes(t, store)
}

// ----------------------------------------------------------------------------

func TestMemcacheSessionFlashes(t *testing.T) {
	store := NewMemcacheStore("", []byte("secret-key"))
	testSessionFlashes(t, store)
}
